                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <div className="text-right">
                                <div className="text-[11px] font-bold text-slate-700">Needs</div>
            ...
            <div className="col-span-8">
              <div className="overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <div className="border-b bg-slate-100 px-5 py-4 dark:border-slate-700 dark:bg-slate-800">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-semibold text-slate-800">{onClockLabel}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="rounded-sm bg-slate-200 px-3 py-2 dark:bg-slate-700">
                        ...
                        <div className="text-sm font-semibold text-slate-900">{currentNeeds.join(", ")}</div>
                      </div>

                      <div className="rounded-sm bg-slate-200 px-3 py-2 dark:bg-slate-700">
                        <div className="text-xs font-bold text-slate-500">Remaining Picks</div>
                        <div className="text-sm font-semibold text-slate-900">{remainingPicksForCurrentTeam}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 rounded-sm border border-slate-300 bg-white p-4">
        ...
        <div className="md:hidden py-4">
          ...
          <div className="overflow-hidden rounded-md border border-slate-300 bg-white text-slate-900 shadow-sm">
              ...
              <div className="flex items-center justify-between px-4 pt-3">
                <div className="flex gap-8">
                  <button
                    ...
                    className={cn(
                      "pb-3 text-[12px] font-semibold uppercase tracking-wide",
                      leftTab === "FULL" ? "border-b-4 border-blue-600 text-slate-900" : "text-slate-600"
                    )}
                  >
                    FULL DRAFT
                  </button>
                  ...
                  <button
                    ...
                    className={cn(
                      "pb-3 text-[12px] font-semibold uppercase tracking-wide",
                      leftTab === "YOUR" ? "border-b-4 border-blue-600 text-slate-900" : "text-slate-600"
                    )}
                  >
                    YOUR PICKS
                  </button>
            ...
            <div className="border-b border-slate-300 bg-white px-4 py-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded bg-slate-100 px-3 py-2">
                    <div className="text-[11px] font-bold text-slate-700">Remaining</div>
                    <div className="text-sm font-semibold text-slate-900">{remainingPicksForCurrentTeam}</div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-h-[55vh] overflow-auto">
              {availablePlayers.map((p) => (
                <div key={p.id} className="border-t border-slate-300 bg-white px-4 py-4 hover:bg-slate-50">
                  <div className="flex items-center justify-between gap-3">
