                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <div className="text-right">
                                <div className="text-[11px] font-bold text-slate-600">Needs</div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-semibold text-slate-700">{onClockLabel}</div>
                      </div>
                    </div>
            ...
            <div className="border-b bg-slate-100 px-4 py-4 dark:border-slate-700 dark:bg-slate-800">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded bg-slate-200 px-3 py-2 dark:bg-slate-700">
                    <div className="text-[11px] font-bold text-slate-600">Remaining</div>
                    <div className="text-sm font-semibold text-slate-900">{remainingPicksForCurrentTeam}</div>
                  </div>
                </div>
              </div>
