    ...
    <div className="space-y-4 p-6 text-slate-900 dark:text-slate-100">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
        ...
        {leaderboard.length === 0 ? (
          <div className="mt-4 text-sm text-slate-500 dark:text-slate-400">Noch keine Einträge vorhanden.</div>
        ) : (
          <div className="mt-4 overflow-x-auto">
            <table className="min-w-full text-left text-sm">
              <thead className="border-b border-slate-200 bg-slate-50 text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200">
                <tr>
